...
/* package gui-test-0.1.0.0 */
#define VERSION_gui_test "0.1.0.0"
#define MIN_VERSION_gui_test(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "gui-test-0.1.0.0"

#define CURRENT_PACKAGE_KEY "gui-test-0.1.0.0"
